...
monitor.setCursorPos(monitor_x/2-21, 16)
monitor.write("Contact bugrey (/mail or Discord) to claim it")

monitor.setCursorPos(monitor_x/2-3, 17)
monitor.write("for free!")
